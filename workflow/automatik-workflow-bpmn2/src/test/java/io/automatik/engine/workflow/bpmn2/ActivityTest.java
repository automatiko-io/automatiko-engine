...
import static io.automatik.engine.api.workflow.ProcessInstance.STATE_COMPLETED;
...
public class ActivityTest extends JbpmBpmn2TestCase {
	...
	public void testMinimalProcess() throws Exception {
		...
		BpmnProcess process = create("BPMN2-MinimalProcess.bpmn2");
	...
	public void testMinimalProcessMetaData() throws Exception {
		...
		DefaultProcessEventListener listener = new DefaultProcessEventListener() {
			...
			public void afterVariableChanged(ProcessVariableChangedEvent event) {
				...
				VariableScope variableScope = (VariableScope) ((io.automatik.engine.workflow.base.core.impl.ProcessImpl) event
						.getProcessInstance().getProcess()).resolveContext(VariableScope.VARIABLE_SCOPE,
								event.getVariableId());
