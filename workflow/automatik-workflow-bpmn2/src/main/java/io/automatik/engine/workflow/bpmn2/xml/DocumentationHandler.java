...
public class DocumentationHandler extends BaseAbstractHandler implements Handler {
    ...
    public Object end(final String uri, final String localName, final ExtensibleXmlParser parser) throws SAXException {
        ...
        } else if (parent instanceof io.automatik.engine.workflow.base.core.Process) {

            ((io.automatik.engine.workflow.base.core.Process) parent).getMetaData().put("Documentation",
