...
public class XmlBPMNProcessDumper implements XmlProcessDumper {
    ...
    public static final String RULE_LANGUAGE = "https://automatik-platform.io/rule";
    ...
    protected void visitProcess(WorkflowProcess process, StringBuilder xmlDump, int metaDataType) {
        ...
        xmlDump.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?> " + EOL + "<definitions id=\"Definition\"" + EOL
                ...
                + "             xmlns:g=\"https://automatik-platform.io/flow/gpd\"" + EOL
                + (metaDataType == META_DATA_USING_DI
                        ...
                        : "")
                + "             xmlns:tns=\"https://automatik-platform.io\">" + EOL + EOL);
        ...
        if (packageName != null && !"io.automatik.processes".equals(packageName)) {
            xmlDump.append(
                    "tns:packageName=\"" + XmlBPMNProcessDumper.replaceIllegalCharsAttribute(packageName) + "\" ");
        }
        if (((io.automatik.engine.workflow.process.core.WorkflowProcess) process).isDynamic()) {
        ...
        List<io.automatik.engine.workflow.process.core.Node> processNodes = new ArrayList<io.automatik.engine.workflow.process.core.Node>();
    ...
    private void visitLanes(WorkflowProcess process, StringBuilder xmlDump) {
        // lanes
        Collection<Swimlane> swimlanes = ((SwimlaneContext) ((io.automatik.engine.workflow.process.core.WorkflowProcess) process)
    ...
    protected void visitErrors(Definitions definitions, StringBuilder xmlDump) {
        ...
        for (io.automatik.engine.workflow.bpmn2.core.Error error : errors) {
    ...
    public void visitNodes(List<io.automatik.engine.workflow.process.core.Node> nodes, StringBuilder xmlDump,
            int metaDataType) {
