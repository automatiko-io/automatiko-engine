...
package io.automatiko.engine.workflow.process;

import static io.automatiko.engine.workflow.process.test.NodeCreator.connect;
...
import io.automatiko.engine.workflow.process.test.NodeCreator;
import io.automatiko.engine.workflow.process.test.TestWorkItemHandler;
...
public class CompensationTest extends AbstractBaseTest {
	...
	private void createBoundaryEventCompensationHandler(
			io.automatiko.engine.workflow.process.core.NodeContainer nodeContainer, Node attachedToNode,
