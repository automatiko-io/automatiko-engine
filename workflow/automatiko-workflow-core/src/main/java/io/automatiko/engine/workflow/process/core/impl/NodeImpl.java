...
import io.automatiko.engine.workflow.base.core.ContextResolver;
import io.automatiko.engine.workflow.base.core.VariableExpression;
import io.automatiko.engine.workflow.base.core.impl.MvelNodeInstanceVariableExpression;
...
public abstract class NodeImpl implements Node, ContextResolver {
    ...
    protected Predicate<io.automatiko.engine.api.runtime.process.ProcessContext> conditionPredicate;
    ...
    public List<Connection> getDefaultIncomingConnections() {
        return getIncomingConnections(io.automatiko.engine.workflow.process.core.Node.CONNECTION_DEFAULT_TYPE);
    }
    ...
    public List<Connection> getDefaultOutgoingConnections() {
        return getOutgoingConnections(io.automatiko.engine.workflow.process.core.Node.CONNECTION_DEFAULT_TYPE);
    }
    ...
    public Context resolveContext(String contextId, Object param) {
        ...
        return ((io.automatiko.engine.workflow.process.core.NodeContainer) parentContainer).resolveContext(contextId,
                param);
    }
    ...
    public void setCondition(Predicate<io.automatiko.engine.api.runtime.process.ProcessContext> conditionPredicate) {
        this.conditionPredicate = conditionPredicate;
    }

    public Predicate<io.automatiko.engine.api.runtime.process.ProcessContext> getCondition() {
        return this.conditionPredicate;
    }

    public boolean isMet(io.automatiko.engine.api.runtime.process.ProcessContext context) {
