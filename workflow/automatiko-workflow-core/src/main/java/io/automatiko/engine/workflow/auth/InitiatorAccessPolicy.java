...
public class InitiatorAccessPolicy<T> implements AccessPolicy<ProcessInstance<T>> {
    ...
    public boolean canReadInstance(IdentityProvider identityProvider, ProcessInstance<T> instance) {
        return whenInitiatorNotSetOrAsIdentityOrParticipant(identityProvider, instance);
    }
    ...
    protected boolean whenInitiatorNotSetOrAsIdentityOrParticipant(IdentityProvider identityProvider,
