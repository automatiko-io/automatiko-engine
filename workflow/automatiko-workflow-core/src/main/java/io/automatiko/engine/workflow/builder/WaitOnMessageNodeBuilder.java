...
public class WaitOnMessageNodeBuilder extends AbstractNodeBuilder {
     ...
     * @return the builder
     */
    public <T> WaitOnMessageNodeBuilder correlation(Correlation<T> expression) {
     ...
     * @return the builder
     */
    public <T> WaitOnMessageNodeBuilder filter(Filter<T> filter) {
     ...
     * @return the builder
     */
    public WaitOnMessageNodeBuilder channel(String name) {
