        ...
        switch (split.getType()) {
            ...
            case Split.TYPE_XAND:
                ...
                if (connections == null || connections.isEmpty()) {
                    ...
                    for (Map.Entry<io.automatiko.engine.workflow.process.instance.NodeInstance, String> entry : nodeInstancesMap
                            .entrySet()) {
                        // stop if this process instance has been aborted / completed
                        if (getProcessInstance().getState() != ProcessInstance.STATE_ACTIVE) {
                            return;
                        ...
                        ((io.automatiko.engine.workflow.process.instance.NodeInstance) entry.getKey()).trigger(this,
                                entry.getValue());
                        if (!hidden) {
