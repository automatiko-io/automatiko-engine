...
public class DynamicUtils {
    ...
    public static void addDynamicWorkItem(
            final io.automatiko.engine.api.runtime.process.ProcessInstance dynamicProcessInstance,
    ...
    public static String addDynamicSubProcess(
            final io.automatiko.engine.api.runtime.process.ProcessInstance processInstance,
    ...
    private static String executeSubProcess(InternalProcessRuntime runtime, String processId,
        ...
        if (process == null) {
            ...
            if (subProcessInstance
                    .getState() == io.automatiko.engine.api.runtime.process.ProcessInstance.STATE_COMPLETED) {
