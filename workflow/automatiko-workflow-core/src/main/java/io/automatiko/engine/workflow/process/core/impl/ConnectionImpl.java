...
public class ConnectionImpl implements Connection, Serializable {
	...
	public void connect() {
		((io.automatiko.engine.workflow.process.core.Node) this.from).addOutgoingConnection(fromType, this);
		((io.automatiko.engine.workflow.process.core.Node) this.to).addIncomingConnection(toType, this);
	}

	public synchronized void terminate() {
		((io.automatiko.engine.workflow.process.core.Node) this.from).removeOutgoingConnection(fromType, this);
		((io.automatiko.engine.workflow.process.core.Node) this.to).removeIncomingConnection(toType, this);
		this.from = null;
		this.fromType = null;
		this.to = null;
		this.toType = null;
