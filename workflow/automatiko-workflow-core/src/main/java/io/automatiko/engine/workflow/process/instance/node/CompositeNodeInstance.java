...
public class CompositeNodeInstance extends StateBasedNodeInstance
    ...
    protected void internalTriggerOnlyParent(final io.automatiko.engine.api.runtime.process.NodeInstance from,
            String type) {
        super.internalTrigger(from, type);
    }
    ...
    public static class CompositeNodeStartInstance extends NodeInstanceImpl {
        ...
        public void triggerCompleted() {
            super.triggerCompleted(io.automatiko.engine.workflow.process.core.Node.CONNECTION_DEFAULT_TYPE, true);
        }
    ...
    public void nodeInstanceCompleted(NodeInstance nodeInstance, String outType) {
        ...
        if (nodeInstance instanceof FaultNodeInstance || nodeInstance instanceof EndNodeInstance
            ...
            if (getCompositeNode().isAutoComplete() && nodeInstances.isEmpty()) {
                triggerCompleted(io.automatiko.engine.workflow.process.core.Node.CONNECTION_DEFAULT_TYPE);
