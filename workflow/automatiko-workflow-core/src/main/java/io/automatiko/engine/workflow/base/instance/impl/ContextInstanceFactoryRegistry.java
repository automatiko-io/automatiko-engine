...
import io.automatiko.engine.workflow.base.instance.context.exception.DefaultExceptionScopeInstance;
import io.automatiko.engine.workflow.base.instance.context.swimlane.SwimlaneContextInstance;
import io.automatiko.engine.workflow.base.instance.context.variable.JsonVariableContextInstanceFactory;
...
public class ContextInstanceFactoryRegistry {
    ...
    public ContextInstanceFactoryRegistry() {
        ...
        this.registry.put(JsonVariableScope.class, new JsonVariableContextInstanceFactory());
    }
