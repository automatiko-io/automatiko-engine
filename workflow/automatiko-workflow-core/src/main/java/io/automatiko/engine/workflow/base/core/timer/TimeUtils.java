...
public class TimeUtils {
    ...
    public static long parseTimeString(String time) {
        ...
        if (trimmed.length() > 0) {
            ...
            if (mat.matches()) {
                long days = (mat.group(SIM_DAY) != null) ? Long.parseLong(mat.group(SIM_DAY)) : 0;
                long hours = (mat.group(SIM_HOU) != null) ? Long.parseLong(mat.group(SIM_HOU)) : 0;
                long min = (mat.group(SIM_MIN) != null) ? Long.parseLong(mat.group(SIM_MIN)) : 0;
                long sec = (mat.group(SIM_SEC) != null) ? Long.parseLong(mat.group(SIM_SEC)) : 0;
                long ms = (mat.group(SIM_MS) != null) ? Long.parseLong(mat.group(SIM_MS)) : 0;
