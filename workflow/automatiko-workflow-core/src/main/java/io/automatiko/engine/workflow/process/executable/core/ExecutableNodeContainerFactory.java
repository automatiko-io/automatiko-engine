...
import io.automatiko.engine.workflow.process.executable.core.factory.MilestoneNodeFactory;
import io.automatiko.engine.workflow.process.executable.core.factory.RuleSetNodeFactory;
...
import io.automatiko.engine.workflow.process.executable.core.factory.StateNodeFactory;
...
public abstract class ExecutableNodeContainerFactory {
    ...
    public ExecutableNodeContainerFactory connection(long fromId, long toId, String uniqueId, boolean association) {
        ...
        ConnectionImpl connection = new ConnectionImpl(from,
                io.automatiko.engine.workflow.process.core.Node.CONNECTION_DEFAULT_TYPE, to,
