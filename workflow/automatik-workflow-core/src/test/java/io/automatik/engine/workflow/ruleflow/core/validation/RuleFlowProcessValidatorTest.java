...
package io.automatik.engine.workflow.ruleflow.core.validation;
...
public class RuleFlowProcessValidatorTest {
	...
	void testCompositeNodeNoStart() {
		...
		new io.automatik.engine.workflow.process.core.impl.ConnectionImpl(startNode, Node.CONNECTION_DEFAULT_TYPE,
				compositeNode, Node.CONNECTION_DEFAULT_TYPE);
		new io.automatik.engine.workflow.process.core.impl.ConnectionImpl(compositeNode, Node.CONNECTION_DEFAULT_TYPE,
