...
public class StartNodeInstanceTest extends AbstractBaseTest {
	...
	public void testStartNode() {
		...
		mockNode.setId(2);
		new ConnectionImpl(startNode, io.automatik.engine.workflow.process.core.Node.CONNECTION_DEFAULT_TYPE, mockNode,
		...
		List<NodeInstance> triggeredBy = mockNodeInstance.getTriggers()
				.get(io.automatik.engine.workflow.process.core.Node.CONNECTION_DEFAULT_TYPE);
