...
import static io.automatik.engine.workflow.base.core.context.exception.CompensationScope.COMPENSATION_SCOPE;
import static io.automatik.engine.workflow.base.core.context.exception.CompensationScope.IMPLICIT_COMPENSATION_PREFIX;
...
class CompensationEventListener implements EventListener {
    ...
    public void signalEvent(String compensationType, Object activityRefStr) {
        ...
        io.automatik.engine.workflow.base.core.Process process = (io.automatik.engine.workflow.base.core.Process) instance
                .getProcess();
