...
import static io.automatik.engine.workflow.process.executable.core.Metadata.INCOMING_CONNECTION;
import static io.automatik.engine.workflow.process.executable.core.Metadata.OUTGOING_CONNECTION;
...
public abstract class NodeInstanceImpl
        implements io.automatik.engine.workflow.process.instance.NodeInstance, Serializable {
    ...
    private io.automatik.engine.workflow.process.instance.NodeInstanceContainer nodeInstanceContainer;
    ...
    public Node getNode() {
        try {
            return ((io.automatik.engine.workflow.process.core.NodeContainer) this.nodeInstanceContainer
    ...
    public final void trigger(NodeInstance from, String type) {
        io.automatik.engine.workflow.process.core.Node currentNode = (io.automatik.engine.workflow.process.core.Node) getNode();
        ...
        if (from != null) {
            int level = ((io.automatik.engine.workflow.process.instance.NodeInstance) from).getLevel();
    ...
    protected void continueToNextNode(String type, Node node) {
        ...
        if (node != null) {
            if ("true".equals(System.getProperty("jbpm.enable.multi.con"))
                ...
                for (NodeInstanceTrigger nodeInstance : nodeInstances) {
                    ...
                    if (((io.automatik.engine.workflow.process.instance.NodeInstanceContainer) getNodeInstanceContainer())
                            .getState() != STATE_ACTIVE) {
                        return;
                    }
        ...
        if (connections == null || connections.isEmpty()) {
            ...
            Map<io.automatik.engine.workflow.process.instance.NodeInstance, String> nodeInstances = new HashMap<>();
            for (Connection connection : connections) {
                nodeInstances.put(followConnection(connection), connection.getToType());
            }
            for (Map.Entry<io.automatik.engine.workflow.process.instance.NodeInstance, String> nodeInstance : nodeInstances
                    .entrySet()) {
                // stop if this process instance has been aborted / completed
                if (((io.automatik.engine.workflow.process.instance.NodeInstanceContainer) getNodeInstanceContainer())
                        .getState() != STATE_ACTIVE) {
    ...
    protected io.automatik.engine.workflow.process.instance.NodeInstance followConnection(Connection connection) {
        ...
        return ((io.automatik.engine.workflow.process.instance.NodeInstanceContainer) getNodeInstanceContainer())
                .getNodeInstance(connection.getTo());
    }

    protected void triggerNodeInstance(io.automatik.engine.workflow.process.instance.NodeInstance nodeInstance,
            String type) {
    ...
    public void triggerNode(long nodeId, boolean fireEvents) {
        io.automatik.engine.workflow.process.instance.NodeInstance nodeInstance = ((io.automatik.engine.workflow.process.instance.NodeInstanceContainer) getNodeInstanceContainer())
    ...
    protected static class NodeInstanceTrigger {
        private io.automatik.engine.workflow.process.instance.NodeInstance nodeInstance;
        private String toType;

        public NodeInstanceTrigger(io.automatik.engine.workflow.process.instance.NodeInstance nodeInstance,
                String toType) {
            this.nodeInstance = nodeInstance;
            this.toType = toType;
        }

        public io.automatik.engine.workflow.process.instance.NodeInstance getNodeInstance() {
            return nodeInstance;
        }
