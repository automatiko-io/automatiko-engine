...
import io.automatik.engine.workflow.process.core.Connection;
...
public class ConnectionImpl implements Connection, Serializable {
	...
	/**
	 * This constructor calls {@link #connect()} itself! That means that simply
	 * creating the object also adds it to the appropriate {@link List} fields in
	 * other objects.
	 * </p>
	...
	public void connect() {
		((io.automatik.engine.workflow.process.core.Node) this.from).addOutgoingConnection(fromType, this);
		((io.automatik.engine.workflow.process.core.Node) this.to).addIncomingConnection(toType, this);
	}

	public synchronized void terminate() {
		((io.automatik.engine.workflow.process.core.Node) this.from).removeOutgoingConnection(fromType, this);
		((io.automatik.engine.workflow.process.core.Node) this.to).removeIncomingConnection(toType, this);
		this.from = null;
		this.fromType = null;
		this.to = null;
		this.toType = null;
