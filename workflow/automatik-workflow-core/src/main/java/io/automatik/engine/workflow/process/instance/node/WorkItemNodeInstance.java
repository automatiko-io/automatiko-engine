...
import static io.automatik.engine.api.runtime.process.WorkItem.ABORTED;
import static io.automatik.engine.api.runtime.process.WorkItem.COMPLETED;
...
import io.automatik.engine.api.workflow.GroupedNamedDataType;
import io.automatik.engine.api.workflow.IOEventDescription;
...
import io.automatik.engine.workflow.process.instance.impl.WorkItemResolverFactory;
...
public class WorkItemNodeInstance extends StateBasedNodeInstance implements EventListener, ContextInstanceContainer {
    ...
    public void signalEvent(String type, Object event) {
        if ("workItemCompleted".equals(type)) {
            ...
            trigger(null, io.automatik.engine.workflow.process.core.Node.CONNECTION_DEFAULT_TYPE);
        } else {
