...
import io.automatik.engine.workflow.marshalling.impl.JBPMMessages.Variable;
import io.automatik.engine.workflow.marshalling.impl.JBPMMessages.VariableContainer;
...
public class ProtobufProcessMarshaller implements ProcessMarshaller {
	...
	public void writeProcessInstances(MarshallerWriteContext context) throws IOException {
		JBPMMessages.ProcessData.Builder _pdata = (JBPMMessages.ProcessData.Builder) context.parameterObject;
		...
		for (io.automatik.engine.api.runtime.process.ProcessInstance processInstance : processInstances) {
			...
			JBPMMessages.ProcessInstance _instance = (JBPMMessages.ProcessInstance) ProcessMarshallerRegistry.INSTANCE
	...
	public void writeWorkItems(MarshallerWriteContext context) throws IOException {
		...
		for (WorkItem workItem : workItems) {
			_pdata.addExtension(JBPMMessages.workItem, writeWorkItemInstance(context, workItem));
		}
	}

	public static JBPMMessages.WorkItem writeWorkItemInstance(MarshallerWriteContext context, WorkItem workItem)
			throws IOException {
	...
	public List<ProcessInstance> readProcessInstances(MarshallerReaderContext context) throws IOException {
		JBPMMessages.ProcessData _pdata = (JBPMMessages.ProcessData) context.parameterObject;
	...
	public static Object unmarshallVariableValue(MarshallerReaderContext context, JBPMMessages.Variable _variable)
