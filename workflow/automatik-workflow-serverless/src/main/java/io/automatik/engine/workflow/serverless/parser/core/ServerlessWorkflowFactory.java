...
public class ServerlessWorkflowFactory {
	...
	public EndNode messageEndNode(long id, String name, Workflow workflow, End stateEnd, NodeContainer nodeContainer) {
		...
		EventDefinition eventDef = ServerlessWorkflowUtils.getWorkflowEventFor(workflow,
				stateEnd.getProduceEvent().getEventRef());
	...
	public ActionNode scriptNode(long id, String name, String script, NodeContainer nodeContainer) {
		...
		scriptNode.setAction(new ConsequenceAction());
		((ConsequenceAction) scriptNode.getAction()).setConsequence(script);
		((ConsequenceAction) scriptNode.getAction()).setDialect("java");
	...
	public WorkItemNode camelRouteServiceNode(long id, String name, Function function, NodeContainer nodeContainer) {
		...
		String metaImpl = ServerlessWorkflowUtils.resolveFunctionMetadata(function, SERVICE_IMPL_KEY,
				workflowAppContext);
	...
	public HumanTaskNode humanTaskNode(long id, String name, Function function, ExecutableProcess process,
			NodeContainer nodeContainer) {
		...
		humanTaskNode.addOutMapping(DEFAULT_DECISION,
				ServerlessWorkflowUtils.resolveFunctionMetadata(function, HT_TASKNAME, workflowAppContext)
						+ DEFAULT_DECISION);
