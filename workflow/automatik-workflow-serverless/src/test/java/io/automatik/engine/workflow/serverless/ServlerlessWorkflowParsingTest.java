...
public class ServlerlessWorkflowParsingTest extends BaseServerlessTest {
	...
	public void testSingleOperationWorkflow(String workflowLocation) throws Exception {
		ExecutableProcess process = (ExecutableProcess) getWorkflowParser(workflowLocation)
	...
	public void testSingleServiceOperationWorkflow(String workflowLocation) throws Exception {
		...
		assertEquals("org.something.other.TestService",
				workItemNode.getWork().getParameter("interfaceImplementationRef"));
	...
	@ParameterizedTest
	@ValueSource(strings = { "/exec/single-operation-many-functions.sw.json",
			"/exec/single-operation-many-functions.sw.yml" })
	...
	public void testSingleIntegrationOperationWorkflow(String workflowLocation) throws Exception {
		...
		assertEquals("org.apache.camel.ProducerTemplate",
				workItemNode.getWork().getParameter("interfaceImplementationRef"));
		assertEquals("Java", workItemNode.getWork().getParameter("implementation"));
	...
	@ValueSource(strings = { "/specexamples/helloworld.sw.json", "/specexamples/helloworld.sw.yml",
			...
			"/specexamples/parallel.sw.json", "/specexamples/parallel.sw.yml", "/specexamples/jobmonitoring.sw.json",
			"/specexamples/jobmonitoring.sw.yml", "/specexamples/sendcloudevent.sw.json",
			"/specexamples/sendcloudevent.sw.yml", "/specexamples/monitorpatient.sw.json",
			"/specexamples/monitorpatient.sw.yml", "/specexamples/finalizecollegeapplication.sw.json",
			"/specexamples/finalizecollegeapplication.sw.yml", "/specexamples/creditcheck.sw.json",
			"/specexamples/creditcheck.sw.yml" })
