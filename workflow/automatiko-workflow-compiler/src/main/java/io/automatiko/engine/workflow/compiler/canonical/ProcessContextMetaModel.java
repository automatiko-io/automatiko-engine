...
public class ProcessContextMetaModel {
	...
	public Expression getVariable(String procVar) {
		...
		MethodCallExpr getter = new MethodCallExpr().setScope(new NameExpr(kcontext)).setName("getVariable")
	...
	public AssignExpr assignVariable(String procVar) {
		...
		return new AssignExpr()
				.setTarget(new VariableDeclarationExpr(new VariableDeclarator()
						.setType(variableScope.findVariable(procVar).getType().getStringType()).setName(procVar)))
				.setOperator(AssignExpr.Operator.ASSIGN).setValue(e);
	}
	...
	public MethodCallExpr setVariable(String procVar) {
		...
		MethodCallExpr setter = new MethodCallExpr().setScope(new NameExpr(kcontext)).setName("setVariable")
