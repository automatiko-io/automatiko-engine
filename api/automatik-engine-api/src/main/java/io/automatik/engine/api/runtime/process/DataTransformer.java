 ...
 * transformation as part of BPMN2 process definition. It allows plugable
 * implementations.
 *
 */
public interface DataTransformer {
	...
	/**
	 * Compiles given expression into reusable unit. This is optional operation and
	 * in case it's not supported by given transformed it should return the same
	 * expression that was given in the input. If compilation is supported a
	 * compiled instance of the expression should be returned.
	 * 
	 ...
	 * @throws RuntimeException in case of unexpected errors during evaluation of
	 *                          the expression
	 */
