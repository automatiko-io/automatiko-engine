...
public interface ProcessVariableChangedEvent extends ProcessEvent {
	...
	/**
	 * The unique id of the process variable instance (as multiple node instances
	 * with the same process variable definition exists). This is an aggregation of
	 * the unique id of the instance that contains the variable scope and the
	 * variable id.
	 *
