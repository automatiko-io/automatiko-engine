...
public class UserTaskInstanceEventBody {
    ...
    private transient HumanTaskWorkItem instance;
    ...
    public HumanTaskWorkItem sourceInstance() {
        return instance;
    }
    ...
    public String toString() {
        return "UserTaskInstanceEventBody [id=" + id + ", taskName=" + taskName + ", taskDescription=" + taskDescription
                + ", startDate=" + startDate + ", completeDate=" + completeDate + ", state=" + state + ", actualOwner="
                + actualOwner + "]";
    }
    ...
    static class Builder {
        ...
        public Builder instance(HumanTaskWorkItem hinstance) {
            instance.instance = hinstance;
            return this;
        }
    }
}
