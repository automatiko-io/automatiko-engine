 ...
 */
public class SecurityAwareBroadcastProcessor<T> extends AbstractMulti<T> implements Processor<T, T> {
    ...
    public void subscribe(MultiSubscriber<? super T> downstream) {
        BroadcastSubscription<T> subscription = new BroadcastSubscription<>(downstream, this, IdentityProvider.get());
    ...
    static final class BroadcastSubscription<T> implements Subscription {
         ...
         */
        BroadcastSubscription(Subscriber<? super T> actual, SecurityAwareBroadcastProcessor<T> parent,
