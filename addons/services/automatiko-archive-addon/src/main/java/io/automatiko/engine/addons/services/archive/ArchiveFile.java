...
public class ArchiveFile implements File<byte[]> {
    ...
    @JsonCreator
    public ArchiveFile(@JsonProperty("name") String name, @JsonProperty("content") byte[] content,
    ...
    public String toString() {
        return "File [name=" + name + ", content (entries)=" + content.length + "]";
    }
