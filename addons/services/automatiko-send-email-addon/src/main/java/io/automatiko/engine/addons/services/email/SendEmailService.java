...
public class SendEmailService {
    ...
    @Inject
    public SendEmailService(Mailer mailer, Engine engine) {
        this.mailer = mailer;
        this.engine = engine;
    }
    ...
    public void send(String tos, String subject, String body, File<byte[]>... attachments) {
        try {
     ...
     * so it can be used within workflow definition to handle it
     * 
     * @param tosc omma separated list of recipients
     * @param ccs comma separated list of CC recipients
     * @param subject subject of the email
     * @param body body of the email
     * @param attachments optional attachments
     */
    public void send(String tos, String ccs, String subject, String body, File<byte[]>... attachments) {
        try {
            for (String to : tos.split(",")) {
                Mail mail = Mail.withHtml(to, subject, body);
     ...
     * @param tos comma separated list of recipients
     * @param subject subject of the email
     * @param templateName name of the email tample to be used to create the body of the email message
     * @param body body of the email
     * @param attachments optional attachments
     */
     ...
     * @param attachments optional attachments
     */
    public void send(String tos, String ccs, String subject, String templateName, Object body, File<byte[]>... attachments) {
        Template template = getTemplate(templateName);
        try {
            Map<String, Object> templateData = new HashMap<>();
            templateData.put("body", body);
