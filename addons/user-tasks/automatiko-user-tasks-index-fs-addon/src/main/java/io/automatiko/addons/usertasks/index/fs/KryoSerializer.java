...
public class KryoSerializer<O> implements PojoSerializer<O> {
    ...
    static <O> void validateObjectIsRoundTripSerializable(O candidatePojo, Class<O> objectType,
        ...
        try {
            ...
            throw new IllegalStateException("POJO object failed round trip serialization-deserialization test, object type: "
                    + objectType + ", object: " + candidatePojo, e);
        }
    }
    ...
    static void validateHashCodeEquality(Object candidate, Object deserializedPojo) {
        if (!(deserializedPojo.hashCode() == candidate.hashCode())) {
            throw new IllegalStateException(
                    "The POJO's hashCode after round trip serialization differs from its original hashCode");
        }
    }
}
