...
public class ClassPathResource implements Resource {
	...
	private io.automatik.engine.services.io.ClassPathResource delegate;

	public ClassPathResource(String location) {
		this.delegate = new io.automatik.engine.services.io.ClassPathResource(location,
				Thread.currentThread().getContextClassLoader());
	}

	public ClassPathResource(io.automatik.engine.services.io.ClassPathResource resource) {
