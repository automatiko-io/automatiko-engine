...
public class ByteArrayResource implements Resource {
	private io.automatik.engine.services.io.ByteArrayResource delegate;

	public ByteArrayResource(byte[] bytes) {
		this.delegate = new io.automatik.engine.services.io.ByteArrayResource(bytes);
	}

	public ByteArrayResource(io.automatik.engine.services.io.ByteArrayResource resource) {
