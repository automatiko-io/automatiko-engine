...
public class DmnRuntimeProvider {
	...
	private static org.kie.api.io.Resource convert(Resource resource) {
		if (resource instanceof io.automatik.engine.services.io.ClassPathResource) {
			return new ClassPathResource((io.automatik.engine.services.io.ClassPathResource) resource);
		} else if (resource instanceof io.automatik.engine.services.io.FileSystemResource) {
			return new FileSystemResource(
					(io.automatik.engine.services.io.FileSystemResource) resource);
		} else if (resource instanceof io.automatik.engine.services.io.ByteArrayResource) {
			return new ByteArrayResource((io.automatik.engine.services.io.ByteArrayResource) resource);
		}
