...
public class FileSystemResource implements Resource {
	private io.automatiko.engine.services.io.FileSystemResource delegate;

	public FileSystemResource(String location) {
		this.delegate = new io.automatiko.engine.services.io.FileSystemResource(location);
	}

	public FileSystemResource(io.automatiko.engine.services.io.FileSystemResource resource) {
