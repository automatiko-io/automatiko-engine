...
import io.automatik.engine.codegen.data.PersonVarInfo;
...
public class ReflectionProtoGeneratorTest {
	...
	public void testPersonProtoFile() {
		...
		Proto proto = generator.generate("io.automatik.engine.test", Collections.singleton(Person.class));
		assertThat(proto).isNotNull();

		assertThat(proto.getPackageName()).isEqualTo("io.automatik.engine.test");
		...
		assertThat(person.getJavaPackageOption()).isEqualTo("io.automatik.engine.codegen.data");
	...
	public void testPersonWithAddressProtoFile() {
		...
		Proto proto = generator.generate("io.automatik.engine.test", Collections.singleton(PersonWithAddress.class));
		assertThat(proto).isNotNull();
		...
		assertThat(address.getJavaPackageOption()).isEqualTo("io.automatik.engine.codegen.data");
	...
	public void testPersonWithListProtoFile() {
		...
		Proto proto = generator.generate("io.automatik.engine.test", Collections.singleton(PersonWithList.class));
		assertThat(proto).isNotNull();
	...
	public void testPersonWithAddressesProtoFile() {
		...
		Proto proto = generator.generate("io.automatik.engine.test", Collections.singleton(PersonWithAddresses.class));
		assertThat(proto).isNotNull();
	...
	public void testPersonAsModelProtoFile() {
		...
		Proto proto = generator.generate("@Indexed", "@Field(store = Store.YES)", "io.automatik.engine.test.persons",
				Person.class);
		assertThat(proto).isNotNull();

		assertThat(proto.getPackageName()).isEqualTo("io.automatik.engine.test.persons");
		assertThat(proto.getSyntax()).isEqualTo("proto2");
		assertThat(proto.getMessages()).hasSize(1);
		...
		assertThat(person.getJavaPackageOption()).isEqualTo("io.automatik.engine.test.persons");
		assertThat(person.getFields()).hasSize(3);
