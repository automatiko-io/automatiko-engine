...
public class DMNRestResourceGenerator {
	...
	private void addMonitoringImports(CompilationUnit cu) {
		cu.addImport(new ImportDeclaration(
				new Name("io.automatik.engine.addons.monitoring.system.metrics.SystemMetricsCollector"), false, false));
		cu.addImport(new ImportDeclaration(
				new Name("io.automatik.engine.addons.monitoring.system.metrics.DMNResultMetricsBuilder"), false,
				false));
		cu.addImport(new ImportDeclaration(
				new Name("io.automatik.engine.addons.monitoring.system.metrics.SystemMetricsCollector"), false, false));
	}
