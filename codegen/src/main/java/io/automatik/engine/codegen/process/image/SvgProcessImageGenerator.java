package io.automatik.engine.codegen.process.image;
...
public class SvgProcessImageGenerator {

    private static final Logger LOGGER = LoggerFactory.getLogger(SvgProcessImageGenerator.class);
    ...
    public SvgProcessImageGenerator(WorkflowProcess workFlowProcess) {
