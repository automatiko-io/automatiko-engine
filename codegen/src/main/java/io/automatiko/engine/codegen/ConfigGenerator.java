...
public class ConfigGenerator {
	...
	private MethodDeclaration generateAddonsMethod() {
		...
		try {
			Enumeration<URL> urls = classLoader.getResources("META-INF/io.automatiko.addon");
			...
			LOGGER.warn("Unexpected exception during loading of io.automatiko.addon files", e);
		}
