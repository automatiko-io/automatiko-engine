...
public class ProcessConfigGenerator {
    ...
    private static final String METHOD_EXTRACT_INSTANCE_FACTORY = "extract_instanceFactory";
    ...
    private static final String VAR_DEFAULT_INSTANCE_FACTORY = "defaultInstanceFactory";
    ...
    private static final String VAR_INSTANCE_FACTORY = "instanceFactory";
    ...
    public ObjectCreationExpr newInstance() {
        if (annotator != null) {
            return new ObjectCreationExpr().setType(StaticProcessConfig.class.getCanonicalName())
                    ...
                    .addArgument(new MethodCallExpr(METHOD_EXTRACT_INSTANCE_FACTORY));
        } else {
            return new ObjectCreationExpr().setType(StaticProcessConfig.class.getCanonicalName())
                    ...
                    .addArgument(new NameExpr(VAR_DEFAULT_INSTANCE_FACTORY));
        }
    }
    ...
    public List<BodyDeclaration<?>> members() {
        ...
        FieldDeclaration defaultInstanceFactoryFieldDeclaration = new FieldDeclaration()
                .setModifiers(Modifier.Keyword.PRIVATE)
                .addVariable(new VariableDeclarator(
                        new ClassOrInterfaceType(null, "io.automatiko.engine.api.workflow.ProcessInstancesFactory"),
                        VAR_DEFAULT_INSTANCE_FACTORY, new NullLiteralExpr()));
        members.add(defaultInstanceFactoryFieldDeclaration);
        ...
        if (annotator != null) {
            ...
            FieldDeclaration instanceFactoryFieldDeclaration = annotator.withInjection(new FieldDeclaration().addVariable(
                    new VariableDeclarator(
                            genericType(annotator.optionalInstanceInjectionType(),
                                    "io.automatiko.engine.api.workflow.ProcessInstancesFactory"),
                            VAR_INSTANCE_FACTORY)));
            members.add(instanceFactoryFieldDeclaration);
