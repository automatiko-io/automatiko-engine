...
public class $Type$Resource {
    ...
    public $ResourceType$(Application application, @jakarta.inject.Named("$id$$version$") Process<$Type$> process, IdentitySupplier identitySupplier, FormProvider formProvider) {
